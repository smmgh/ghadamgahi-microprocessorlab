...
; 0000 0026 DDRA=0b00000000;
	LDI  R30,LOW(0)
	OUT  0x1A,R30
; 0000 0027 PORTA=0b00000000;
	OUT  0x1B,R30
...
; 0000 0090 // Characters/line: 20
; 0000 0091 lcd_init(20);
	LDI  R26,LOW(20)
	RCALL _lcd_init
; 0000 0092 
; 0000 0093 
...
; 0000 009D        if(counter % 100 == 0){
	...
	SBIW R30,0
	BRNE _0x7
; 0000 009E               lcd_putchar(counter/100);
	MOVW R26,R4
	LDI  R30,LOW(100)
	LDI  R31,HIGH(100)
	CALL __DIVW21
	MOV  R26,R30
	RCALL _lcd_putchar
; 0000 009F               if( counter == 2000) lcd_gotoxy(0,1);
	LDI  R30,LOW(2000)
	LDI  R31,HIGH(2000)
	CP   R30,R4
	CPC  R31,R5
